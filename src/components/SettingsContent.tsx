...
export function SettingsContent({ isDarkMode, onToggleDarkMode }: SettingsContentProps) {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-lg font-semibold text-gray-800 mb-4">Advanced Features</h2>
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-600 rounded opacity-60">
            <div className="flex flex-col">
              <span className="text-gray-700 dark:text-gray-300">Cloud Sync</span>
              <span className="text-xs text-gray-500">Currently not working and it is on the way</span>
            </div>
            <div className="w-10 h-5 bg-gray-300 dark:bg-gray-600 rounded-full relative">
